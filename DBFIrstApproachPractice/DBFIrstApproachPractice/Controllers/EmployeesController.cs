...
namespace DBFIrstApproachPractice.Controllers
{
    ...
    {
        private readonly ActsPuneContext _context;

        public EmployeesController(ActsPuneContext context)
        {
            _context = context;
        }
        ...
        {
            var actsPuneContext = _context.Employees.Include(e => e.DeptNoNavigation);
            return View(await actsPuneContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ActsPuneContext.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
